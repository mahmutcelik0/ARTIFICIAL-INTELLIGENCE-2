...
public class Chromosome implements Cloneable {
    ...
    public void setAllGenesToZero(){
        for(int x:geneOfChromosome){
            geneOfChromosome[x] = 0;
        }
    }

    public void setSelectedGeneToOne(int index){
        geneOfChromosome[index] = 1;
    }

    public void setSelectedGeneToZero(int index){
        geneOfChromosome[index] = 0;
    }
